int main()
{
    ...
    for (int t = 0; t < steps; t++) {
        ...
        double error = evaluation(myrobot, p, n);
        cout << "Step = " << t << " , Evaluation = " << error << endl;
        // the pirnt showed it varied between 7 and 1.x meters, never less than 1, but it did 
        // converge to around 1.5
    } //End of Steps loop
    return 0;
}
